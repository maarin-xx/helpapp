...
def main():
    ...
    #imgL = cv.pyrDown(cv.imread(cv.samples.findFile('depth1.jpg')))  # downscale images for faster processing
    #imgR = cv.pyrDown(cv.imread(cv.samples.findFile('depth2.jpg')))
